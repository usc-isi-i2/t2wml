...
DEFAULT_SPARQL_ENDPOINT = 'https://dsbox02.isi.edu:8888/bigdata/namespace/wdq/sparql' #need to move to settings.py?
provider_settings={
    "provider":SparqlProvider(DEFAULT_SPARQL_ENDPOINT)
    }
