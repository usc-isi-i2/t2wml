...
describe('open a project', function () {
  ...
  it('button Text = New project', async () => {
    ...
    await appProject.client.pause(3000);
    const sidebar = await projectComponent.react$('Sidebar');
    console.log(3)
    // console.log(sidebar);
    const htmlSidebar = await sidebar.getHTML();
    console.log(htmlSidebar)
    const cardFileTree = await sidebar.$('#card-file-tree-body');
    console.log(cardFileTree)
  });
